...
class Clienti2 extends StatefulWidget {
  Clienti2();

  @override
  State<Clienti2> createState() => ClientiState2();

}



class ClientiState2 extends State<Clienti2> {
  ...
  // List<DipendenteDesignato> dipendentiDesignati=[];  //tiene tutti i dipendenti disponibili
  //
  ...
  // }
  //
  // void getDipendentiPerCliente(int idCliente) async{
  //
  //   String tt=modello.token!;
  ...
  //
  //   if (response.statusCode == 200) {
  //     for(var j in inspect){
  //       for(var dip in dipendentiDesignati) {
  //         if (j["dipendenteId"]==dip.dipendenteId) {
  //           dip.isChecked=true;
  //         }
  //       }
  //     }
  ...
  // }
  //
  // Future<http.StreamedResponse> insertCliente(String nuovoCodiceCliente, String nuovoNome, String nuovoCognome, String nuovaMail, String nuovoTelefono)async{
  //
  //
  //   String idDipDes="";
  //   for (var dip in dipendentiDesignati){
                                                      ...
                                                      content: Form(
                                                        ...
                                                        child: Column(
                                                          ...
                                                          children: <Widget>[
                                                            ...
                                                            Wrap(
                                                              // children: dipendentiDesignati.map((favorite) {
                                                              //   getDipendentiPerCliente(item.clienteId);
                                                  ...
                                                  children: [
                                                    Padding(
                                                      ...
                                                      child: ElevatedButton(
                                                        ...
                                                        //     }
                                                        //
                                                        //     http.StreamedResponse response= await insertCliente(nuovoCodiceCliente!, nuovoNome!, nuovoCognome!, nuovaMail!, nuovoTelefono!);
                                                        //
                                                        //
                                                        //     var jsonData=  jsonDecode(await response.stream.bytesToString());
                                                        //
